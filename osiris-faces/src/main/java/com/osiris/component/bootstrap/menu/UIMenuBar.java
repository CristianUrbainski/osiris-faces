...
/**
 * 
 * Classe que representa um component de barra menu.
 * 
...
@FacesComponent(value = UIMenuBar.COMPONENT_TYPE)
public class UIMenuBar extends UIPanel {

	/**
	 * Tipo do componente.
	 */
	public static final String COMPONENT_TYPE = "com.osiris.component.bootstrap.MenuBar";
	 ...
	 */
	private static final String DEFAULT_RENDERER = "com.osiris.component.bootstrap.MenuBarRenderer";
	...
	/**
	 * Construtor default do componente de barra de menu.
	 */
	public UIMenuBar() {
