...
/**
 * 
 * Classe que representa o conteudo de um componente de menu.
 * 
...
@FacesComponent(value = UIModalBody.COMPONENT_TYPE)
public class UIModalBody extends UIPanel {
	
	/**
	 * Tipo do componente.
	 */
	public static final String COMPONENT_TYPE = "com.osiris.component.bootstrap.ModalBody";
	...
	/**
	 * Renderizador padr�o do componente.
	 */
	private static final String DEFAULT_RENDERER = "com.osiris.component.bootstrap.ModalBodyRenderer";
	...
	/**
	 * Classe interna para definiçãoo dos parametros da classe.
	 * 
	 * @author Cristian Urbainski<cristianurbainskips@gmail.com>
	 * @since 18/07/2013
	 * @version 1.0
